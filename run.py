...
admin.add_url_rule(rule='/account/password', endpoint='password', view_func=login_required(check_admin(AdminPasswordView.as_view('admin_password_view'))), methods=['GET', 'POST'])
admin.add_url_rule(rule='/management/account', endpoint='account', view_func=login_required(check_admin(AccountView.as_view('admin_account_view'))), methods=['GET', 'POST'])
admin.add_url_rule(rule='/management/product', endpoint='product', view_func=login_required(check_admin(ProductView.as_view('admin_product_view'))), methods=['GET', 'POST'])
...
admin.add_url_rule(rule='/management/<string:question_id>', endpoint='response', view_func=login_required(check_admin(ResponseView.as_view('admin_response_view'))), methods=['GET', 'POST'])
